...
>
  ...
  >
    <ul class="menu-list">
      ...
      >
        ...
        >
          <li>
            <a
              href="index.php"
              class="text-white inline-block pb-1 pl-3 menu-list-item-dropdown-list text-base md:text-lg leading-8 md:leading-[50px] "
              >Homepage 01 -
          ...
          <li>
            <a
              href="homepage-02.php"
              class="text-white inline-block pb-1 pl-3 menu-list-item-dropdown-list text-base md:text-lg leading-8 md:leading-[50px] "
              >Homepage 02 -
              <span class="font-instrument italic text-white"
                >Digital Solutions Agency</span
              ></a
            >
          </li>
          <li>
            <a
              href="homepage-03.php"
              class="text-white inline-block pb-1 pl-3 menu-list-item-dropdown-list text-base md:text-lg leading-8 md:leading-[50px] "
              >Homepage 03 -
              <span class="font-instrument italic text-white"
                >Portfolio</span
      ...
      <li
        class="menu-list-item menu-list-item-anchor w-full active"
      >
        <a
          href="#"
          class="text-white text-[28px] md:text-[42px] xl:text-[56px] leading-[70px] xl:leading-[90px] menu-list-item-text"
        ...
        >
          ...
          <li>
            <a
              href="project-details-02.php"
              class="text-white inline-block pb-1 pl-3 menu-list-item-dropdown-list text-base md:text-lg leading-8 md:leading-[50px] active"
              >Project Details 02
            </a>
          </li>
        </ul>
...
>
  <div class="container">
    ...
    >
      ...
      <div class="lg:col-span-5">
        ...
        <p class="max-lg:text-justify">
          Many desktop publishing software and web design tools now use Lorem
          Ipsum as placeholder text by default, and a search for 'lorem ipsum'
          will reveal numerous websites still in development.
        </p>
      </div>
    </div>
    ...
    <div class="project-details2-body">
      <p class="reveal-me">
        The web is a dynamic and flexible platform that enables users to design,
        build, and launch websites without requiring coding skills. Its
        user-friendly interface, robust features, and adaptability have made it
        popular among designers, developers, and businesses alike.
      </p>

      <article class="reveal-me">
        <h3>Exploring Web: An Overview of Its Features</h3>
        <p>
          At its core, Web is a platform for web design and development that
          merges the ease of a visual design tool with the functionality of a
          content management system (CMS). It allows users to build responsive,
          interactive websites without needing to write any code.
        </p>
        <p>
          With Web, designers can simply drag and drop elements onto the canvas,
          customize their layouts, and visually control how the elements adapt
          to different screen sizes.
        </p>
        <p>
          One of Web’s standout features is its dynamic CMS. Unlike traditional
          static website builders, this CMS enables users to effortlessly create
          and manage dynamic content. Whether it's blog posts, product listings,
          or other data-driven content, users can easily add and update content
          without navigating complex code.
        </p>
      </article>
      ...
      <article class="reveal-me">
        ...
        <p>
          Website caters to a diverse audience, offering a range of features to
          suit different users:
        </p>

        <h3>Web Designers</h3>
        <p>
          Website offers an ideal creative space for web designers, allowing
          them to fully express their creativity without worrying about coding.
          Its intuitive visual interface lets designers easily experiment with
          layouts, animations, and interactions in a seamless workflow.
        </p>

        <h3>E-commerce Stores</h3>
        <p>
          Website is perfect for e-commerce businesses, offering tools to easily
          set up and manage online stores. With integrated features for product
          listings, payment options, and order management, businesses can create
          a seamless shopping experience without needing complex coding or
          third-party plugins.
        </p>
      </article>
    </div>
