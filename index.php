...
======================================-->
  <section class="pt-[137px] md:pt-[160px] xl:pt-[180px] pb-20 md:pb-[100px] relative overflow-hidden">
    ...
    <div id="hero-gradient-wrapper" class="absolute w-full h-full top-0 left-0 -z-10 blur-[35px] md:blur-[60px]">
      <img src="images/placeholder.webp" data-src="images/hero-gradient-background.webp"
        alt="Orbizen Software Solutions Background" id="hero-gradient"
    ...
    <div class="container reveal-me">
      <div class="text-center">
        ...
        <p class="mb-10 md:mb-14 xl:mb-[76px] max-w-xl lg:max-w-[750px] mx-auto">
          Orbizen delivers custom software development, web applications, and digital transformation services. Our team
          of expert developers creates secure, scalable, and innovative solutions tailored to your business needs.
        </p>
    ...
    <div class="container">
      ...
      <div class="flex flex-col items-center lg:items-stretch justify-center lg:justify-normal reveal-me">
        ...
        <div
          ...
          <figure>
            <img src="images/icons/text-circle-logo.webp" style="width: 55px " alt="text-circle-logo"
              class="inline dark:hidden">
            <img src="images/icons/text-circle-dark-logo.webp" style="width: 55px " alt="text-circle-logo"
    ...
    <div class="container">
      ...
      <div
        ...
        <div class="flex-1  ">
          ...
          <ul class=" max-md:w-full mt-5 md:mt-10 reveal-me"
            style="text-align: right; translate: none; rotate: none; scale: none; filter: none; transform: translate(0px, 0px); opacity: 1;">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <a href="project-details.php" class="w-full">
            <figure class="overflow-hidden">
              <img class="w-full h-full block transition-all duration-500 group-hover:scale-125"
                src="images/services/services-1.webp" alt="Services Image">
            </figure>
            <div
        ...
        <div class="relative group cursor-pointer reveal-me">
          <a href="project-details.php" class="w-full">
            <figure class="overflow-hidden">
              <img class="w-full h-full block transition-all duration-500 group-hover:scale-125"
                src="images/services/services-2.webp" alt="Services Image">
            </figure>
            <div
              class="bg-secondary/50 backdrop-blur w-[calc(100%-20px)] py-2.5 pl-5 sm:pl-10 mx-2.5 absolute bottom-4 pr-2.5 flex items-center justify-between group-hover:scale-[1.01] transition-all duration-500">
        ...
        <div class="relative group cursor-pointer reveal-me">
          <a href="project-details.php" class="w-full">
            <figure class="overflow-hidden">
              <img class="w-full h-full block transition-all duration-500 group-hover:scale-125"
                src="images/services/services-3.webp" alt="Services Image">
            </figure>
            <div
              class="bg-secondary/50 backdrop-blur w-[calc(100%-20px)] py-2.5 pl-5 sm:pl-10 mx-2.5 absolute bottom-4 pr-2.5 flex items-center justify-between group-hover:scale-[1.01] transition-all duration-500">
        ...
        <div class="relative group cursor-pointer reveal-me">
          <a href="project-details.php" class="w-full">
            <figure class="overflow-hidden">
              <img class="w-full h-full block transition-all duration-500 group-hover:scale-125"
                src="images/services/services-4.webp" alt="Services Image">
            </figure>
            <div
              class="bg-secondary/50 backdrop-blur w-[calc(100%-20px)] py-2.5 pl-5 sm:pl-10 mx-2.5 absolute bottom-4 pr-2.5 flex items-center justify-between group-hover:scale-[1.01] transition-all duration-500">
      ...
      <div
        ...
        <div class="flex-1 max-w-lg">
          <p class=" max-md:text-justify dark:text-colorText text-appear-2">
            Orbizen develops enterprise software solutions that drive innovation and efficiency. From custom development
            to cloud migration, we deliver technology that powers your business growth.
          </p>
        </div>
      </div>
    </div>
      ...
      <h2 class="text-center xl:text-[96px] font-normal xl:leading-[1.1] xl:tracking-[-2.88px]">
        ...
        <div
          ...
          <div class="cta-inline-slider">
            <div class="slide">
              <img src="images/agent/01.webp" alt="Orbizen Software Team Member" loading="lazy">
            </div>
            <div class="slide">
              <img src="images/agent/02.webp" alt="Orbizen Software Expert" loading="lazy">
            </div>
            <div class="slide">
              <img src="images/agent/03.webp" alt="Orbizen Development Team" loading="lazy">
            </div>
          </div>
        </div>
        Talk to our experts.

        <span class="font-instrument sm:mt-10 italic block max-md:inline-block">Schedule your discovery call
          today</span>
      </h2>
