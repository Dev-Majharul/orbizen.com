...
?>
      ...
      <ul class="menu-list">
        ...
        <li class="menu-list-item menu-list-item-anchor w-full ">
          ...
          <ul class="menu-list-item-dropdown relative md:absolute top-0 w-full md:w-auto h-fit left-0 md:left-[48%]">
            ...
            <li>
              <a href="mailto:info@orbizen.com"
                class="text-white inline-block pb-1 pl-3 menu-list-item-dropdown-list text-base md:text-lg leading-8 md:leading-[50px] ">Mail Us
              </a>
            </li>
            <li>
              <a href="https://wa.me/2348130000000"
                class="text-white inline-block pb-1 pl-3 menu-list-item-dropdown-list text-base md:text-lg leading-8 md:leading-[50px] ">Call Us
              </a>
            </li>
            <li>
              <a href="https://cal.com/orbizen/30min"
                class="text-white inline-block pb-1 pl-3 menu-list-item-dropdown-list text-base md:text-lg leading-8 md:leading-[50px] ">Schedule a Meeting
              </a>
            </li>
          </ul>
        </li>
    ...
    <div class="menu-footer max-lg:hidden lg:block fixed bottom-0 w-full border-t border-white border-opacity-10">
      <div
        ...
        <div class="flex gap-6">
          <span>
            <a href="https://www.facebook.com/orbizenlimited">
          ...
          <span>
            <a href="https://www.youtube.com/@orbizenlimited">
              <svg xmlns="http://www.w3.org/2000/svg" class="stroke-[#565656] hover:stroke-white duration-200"
          ...
          <span>
            <a href="https://www.instagram.com/orbizenlimited">
              <svg xmlns="http://www.w3.org/2000/svg" class="stroke-[#565656] hover:stroke-white duration-200"
                width="23" height="23" viewbox="0 0 20 20" fill="none">
                <path
          ...
          <span>
            <a href="https://www.linkedin.com/company/orbizen-limited">
              <svg xmlns="http://www.w3.org/2000/svg" class="stroke-[#565656] hover:stroke-white duration-200"
                width="23" height="23" viewbox="0 0 20 20" fill="none">
                <path
                  d="M10 17.5C14.1421 17.5 17.5 14.1421 17.5 10C17.5 5.85786 14.1421 2.5 10 2.5C5.85786 2.5 2.5 5.85786 2.5 10C2.5 14.1421 5.85786 17.5 10 17.5Z"
          ...
          <span>
            <a href="https://www.figma.com/@orbizenlimited">
              <svg xmlns="http://www.w3.org/2000/svg" class="stroke-[#565656] hover:stroke-white duration-200"
                width="23" height="23" viewbox="0 0 20 20" fill="none">
                <path
  ...
  <div class="toggle-button fixed right-10 bottom-10 z-[1000]">
    <button id="theme-toggle" type="button"
      ...
      <svg data-testid="geist-icon" id="theme-toggle-dark-icon" class="hidden w-5 h-5" fill="#fff"
        stroke-linejoin="round" viewbox="0 0 16 16">
        <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          fill="#fff" transform="translate(2.25, 2.25)"></path>
      </svg>
      <svg id="theme-toggle-light-icon" class="hidden w-5 h-5" fill="#000" viewbox="0 0 16 16" data-testid="geist-icon"
        ...
        <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          fill="#000" transform="translate(1.25, 1.25)"></path>
      </svg>
    </button>
  </div>
